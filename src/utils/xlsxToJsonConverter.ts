...
export const COLUMN_SYNONYMS: Record<string, string[]> = {
  ...
  energy_consumption_on_mode: ['energy consumption in on-mode', 'energy consumption on mode', 'energy_consumption_on_mode', '工作模式下的功耗'],
  light_source_useful_luminous_flux_lm: ['the useful luminous flux', 'the useful luminous flux (φuse)', 'light source useful luminous flux', '光源有效光通'],
  light_source_on_mode_power_w: ['light source on-mode power', 'light source on mode power', 'light source on-mode power(pon)'],
  light_source_standby_power_w: ['light source standby power', 'light source standby power(psb)', '待机功率'],
  light_source_outer_dimensions_high_mm: ['light source outer dimensions (height)', 'light source outer dimensions height', 'light source height'],
  light_source_outer_dimensions_width_mm: ['light source outer dimensions (width)', 'light source outer dimensions width', 'light source width'],
  light_source_outer_dimensions_depth_mm: ['light source outer dimensions (depth)', 'light source outer dimensions depth', 'light source depth'],
  r9_cri_value: ['r9 colour rendering index', 'r9 colour rendering index value', 'r9 cri', 'r9值', 'r9_cri_value'],
